...
public class LoginValidator {
    ...
    /**
     * Validates if the provided username is in the format of an email address.
     *
    ...
    public static void main(String[] args) {
        ...
        // Örnek kullanıcı adları ve şifreler
        String[] usernames = {
                "user@example.com",
                "invalid.email",
                "another@domain.co"
        ...
        // Kullanıcı adlarını ve şifreleri doğrula
        for (String username : usernames) {
            boolean isValidUsername = loginValidator.validateUsername(username);
            System.out.println(username + " is a valid username: " + isValidUsername);
        }

        for (String password : passwords) {
            boolean isValidPassword = loginValidator.validatePassword(password);
            System.out.println(password + " is a valid password: " + isValidPassword);
        }
    }
}